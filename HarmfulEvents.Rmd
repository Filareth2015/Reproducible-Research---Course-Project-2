...
```{r}        
harmfulForHealthEvents <- arrange(aggregate_data, desc(fatalities + injuries))
```


```{r} 
economicConsequences <- arrange(aggregate_data, desc(property_damage + crop_damage))
```
...
ggplot(data = head(harmfulForHealthEvents, 7), 
  ...
  theme(axis.text.x = element_text(angle = 90, 
                                   hjust = 1)) + 
  ggtitle("The most harmful events for population health") + 
  xlab("Weather events") + 
...
ggplot(data = head(economicConsequences, 7), 
  ...
  theme(axis.text.x = element_text(angle = 90, 
                                   hjust = 1)) + 
  ggtitle("Events with the highest economic consequences") + 
  xlab("Weather events") + 
